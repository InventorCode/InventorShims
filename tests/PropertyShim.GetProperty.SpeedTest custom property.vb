...
'Module SpeedTestMain '<CollectorPrepend>'</CollectorPrepend>
    ...
    Public Sub Test1()
        ...
        Dim value As String
        value = PropertyShim.GetProperty(_doc, "Sheet")

    End Sub

    Public Sub Test2()
        Dim _doc As Inventor.Document = ThisApplication.ActiveDocument
        Dim propertySet As Inventor.PropertySet = _doc.PropertySets.Item("Inventor User Defined Properties")
        Dim value As String
        value = propertySet.Item("Sheet").Value
